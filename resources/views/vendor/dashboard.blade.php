                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(index, booking) {
                            ...
                            events.push({
                                ...
                                date: booking.date,
                                name: booking.name,
                                color: '#888' // Gray color for booked dates
                            });
                        });
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(index, booking) {
                            ...
                            events.push({
                                title: 'Booked',
                                start: booking.date,
                                end: booking.date, // assuming each booking is for one day only
                                name: booking.name,
                                contact: booking.contact_no, // assuming contact number is in booking data
                                color: '#888' // Gray color for booked dates
                            });
                        });
                        // Return the formatted events
