                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-2" style="margin-top:5px;">
                                ...
                                <input type="text" class="form-control" name="linkedin_link" placeholder="Linkedin Link"
                                    value="{{ $edit_listing->linkedin_link }}">
                            </div>
                            <div class="col-md-2" style="margin-top:5px;">
                    ...
                    <div class="col-md-6 ">
                        <div class="panel panel-defult">
                            <div class="panel-body">
                                ...
                                <div class="col-md-5">
                                    <label>Select Wedding Vanue Type</label>
                                            ...
                                            @foreach (json_decode($edit_amenity_listing) as $amenity)
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="capacity[]"
                                                            style="border:none; width: 100%;"
                                                            value="{{ $amenity->capacity }}"></td>
                                                    <td><input type="text" name="price[]"
                                                            style="border:none; width: 100%;"
                                                            value="{{ $amenity->price }}"></td>
                                                    <td style="text-align:center; color:#FF0000"> <a
                    ...
                    <div class="col-md-6 ">
                        <div class="panel panel-defult">
                            <div class="panel-body">
                                ...
                                <div class="col-md-3">
                                    <label>Wedding Vanue Type</label>
                                    {{-- <input type="text" class="form-control" id="amenities_for_booking" placeholder=""
                                        value=""> --}}
                                ...
                                <div class="col-md-12" style="margin-top: 2vh;">
                                    <table width="100%" border="1">
                                        <tr style="background-color:#f0f0f0; height:30px;">
                                            <th width="20%" style="text-align:center">Wedding Vanue Type</th>
                                            ...
                                            @foreach (json_decode($edit_time_slot) as $time_slot)
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="from_time_slot[]"
                                                            style="border:none; width: 100%;"
                                                            value="{{ $time_slot->from_time_slot }} "></td>
                                                    <td><input type="text" name="to_time_slot[]"
                                                            style="border:none; width: 100%;"
                                                            value="{{ $time_slot->to_time_slot }} "></td>
                                                    <td style="text-align:center; color:#FF0000">
                                                        <a href="javascript:void(0)">
                                                            <button type="button" data-id="{{ $time_slot->time_id }}"
                                                                style="text-align:center; color:#FF0000"   class=" del_time"><i class="fa fa-trash-o"></i></button>
                                                        </a>
                                                    </td>
                                                </tr>
                                            @endforeach
        ...
        $(document).ready(function() {
            $(".add-row").click(function() {
                ...
                var markup =
                    ...
                    amenities_for_booking_name + '" readonly></td>' +
                    '<td><input type="text" name="capacity[]" required style="border:none; width: 100%;" value="' +
                    capacity + '"></td>' +
                    '<td><input type="text" name="price[]" required style="border:none; width: 100%;" value="' +
                    price + '"></td>' +
            ...
            $(".add-row-vendor").click(function() {
                ...
                var markup =
                    '<tr><td><input type="text" name="vendor_name[]" required="" style="border:none; width: 100%;" value="' +
                    vendor_name + '"></td>' +
                    '<td><input type="text" name="vendor_description[]" required="" style="border:none; width: 100%;" value="' +
                    vendor_description + '"></td>' +
                    '<td><input type="text" name="vendor_offer[]" required="" style="border:none; width: 100%;" value="' +
                    vendor_offer + '"></td>' +
                    '<td><input type="text" name="vendor_discount[]" required="" style="border:none; width: 100%;" value="' +
                    vendor_discount + '"></td>' +
                    '<td><input type="text" name="vendor_price[]" required="" style="border:none; width: 100%;" value="' +
            ...
            $(".add-row-time").click(function() {
                ...
                var markup =
                    '<tr><td><input type="hidden" required="" name="category_id[]" style="border:none; width: 100%;" value="' +
                    category_id +
                    '"><input type="text" required="" style="border:none; width: 100%;" value="' +
                    category_name.trim() + '" readonly></td>' +
                    '<td><input type="text" name="from_time_slot[]" required="" style="border:none; width: 100%;" value="' +
                    from_time_slot + '"></td>' +
                    '<td><input type="text" name="to_time_slot[]" required="" style="border:none; width: 100%;" value="' +
                    to_time_slot + '"></td>' +
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status) {
                    ...
                    $('button[data-id="' + id + '"][data-index="' + index + '"]').closest('tr').remove();
                } else {
