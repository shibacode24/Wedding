        ...
        <div class="page-content">
            ...
            <ul class="x-navigation x-navigation-horizontal">
                <li class="xn-logo" style="margin-right:30px;">
                    <a> <img src="{{asset('public/panel/logo/weeding-logo.png')}}" alt="" style="width: 70%;margin-top: -2.5vh;" /></a>
                ...
                <li>
                 ...
                 <li class="xn-icon-button pull-right">
                    <a href="#" class="mb-control" data-box="#mb-signout"><img src="{{ asset('public/images/power_white.png') }}" style="width:50%;"></a>                        
                </li> 
                <!-- MESSAGES -->
