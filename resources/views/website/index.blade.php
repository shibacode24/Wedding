...
@section('content')
                        ...
                        <form action="{{ route('website_index') }}" method="GET">
                            <div class="main_input_search_part">
                                ...
                                <button type="submit" class="button"
                                    style="background-color:#fff; color:red; border:1px solid; border-color:red;">Search</button>
                            </div>
                        </form>
    ...
    <section class="padding-bottom-70" data-background-color="#f9f9f9" id="hall1">
        <div class="container">
            <div class="row ">
                <div class="col-md-12">
                    <h3 class="headline_part centered margin-bottom-45">Most Popular Wedding Hall</h3>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        ...
                        <a href="{{ route('about') }}" class="button margin-top-25"
                            style="background-color:#fff; color:red; border:1px solid; border-color:red; font-weight:400;">Know
                            More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="utf_testimonial_carousel testimonials">
                @foreach ($approve_listing as $listing)
                    @foreach ($listing->reviews as $review)
                        {{-- Iterate over reviews associated with the listing --}}
